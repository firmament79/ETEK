...
1. ChatGPT 設定 → **Connected Apps → GitHub**
2. 授權 repo：`firmament79/ETEK`
3. 在自訂 GPT 中勾選使用 GitHub 作為知識來源
...
ETEK/
├─ package_EtekBoard_index.json # Boards Manager 主描述檔
├─ EtekBoard-2.1.8.zip # 套件版本 2.1.8
├─ EtekBoard-2.1.9.zip # 套件版本 2.1.9 (示例)
└─ ...（未來版本）
...
1. 修改 / 解壓 ZIP → 調整核心、variant、pins
2. 重新壓縮為： EtekBoard-x.y.z.zip
3. 更新 `package_EtekBoard_index.json` 中：
- `version`
- `url`
- `archiveFileName`
- `size`（可用 zip 檔案大小）
